...
class TemporalFake extends Temporal
{
    ...
    public function getTemporalContext(): Workflow\WorkflowContextInterface
    {
        ...
        return match (true) {
            ...
            default => throw new \RuntimeException('Current context is not a valid Temporal context.'),
        };
    }
