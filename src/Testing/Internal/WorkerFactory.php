...
use Temporal\Testing\WorkerFactory as TemporalWorkerFactory;
...
class WorkerFactory implements WorkerFactoryInterface, LoopInterface
{
    ...
    public static function create(
        ...
        return new static(
            ...
            $rpc ?? Goridge::create(),
            $activityCache ?? \Temporal\Worker\ActivityInvocationCache\RoadRunnerActivityInvocationCache::create(),
        );
    }

    public function newWorker(
        string $taskQueue = TemporalWorkerFactory::DEFAULT_TASK_QUEUE,
